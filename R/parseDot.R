...
#' Sets and instatiates a list, returns to variable; use `$` to access the sets relating to this functions results.
#'
...
parseDot <- function(file) {
	...
	message(glue::glue("Instantiated as list parts. Use $ to access."))
